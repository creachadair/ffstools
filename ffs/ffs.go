...
FFS_PASSPHRASE : If set, a file path with a passphrase for --key (overrides FFS_GETPASS)
...
Within the arguments to FFS_GETPASS, the string "{target}" is replaced by the name
of the target keyring.
`}, {
				Name: "key-format",
