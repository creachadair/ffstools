...
An index is a Bloom filter of the keys reachable from the root.
If a root already has an index, it is not changed; use -f to force
a new index to be computed anyway.`,
